...
| Документ | Опис |
|----------|------|
| SSD | Функціональні та нефункціональні вимоги системи |
| SDD | Архітектура, компоненти, API та взаємодія сервісів |
| ISD | Інфраструктура, деплой та масштабування |
...
| Документ | Опис |
|----------|------|
| Test Strategy | Загальний підхід до тестування системи |
| Traceability Matrix | Зв’язок між вимогами та тест-кейсами |
...
| Документ | Опис |
|----------|------|
| Onboarding Guide | Налаштування проєкту, правила Git, старт роботи |
